...
public extension NSViewController{
   ...
   public func addSSChildViewController(child:NSViewController){
        
        let subView = child.view;//Child
        self.addSSChildViewController(child: child, withView: subView)
    }
   public func fit(childView: NSView, parentView: NSView) {
   ...
   public func addSSChildViewController(child:NSViewController, withView subView:NSView){
